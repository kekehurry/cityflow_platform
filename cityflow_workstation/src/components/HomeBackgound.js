...
const HomeBackground = () => {
    ...
    useEffect(() => {
        ...
        const gridSize = 20;
        const divisions = 20;
        let start_gridHelper = new THREE.GridHelper(gridSize, divisions,0x424242,0x424242);
        ...
        // create buildings
        const buildings = [];
        const buildingMaterial = new THREE.MeshPhongMaterial({ color: 0x282828, transparent: true, opacity: 0.8 });
